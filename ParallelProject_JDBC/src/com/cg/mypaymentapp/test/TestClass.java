...
WalletService service;
	...
	{
		WalletService customer=new WalletServiceImpl();
		WalletService customer2=new WalletServiceImpl();
		customer.createAccount("mndp","9848619922", new BigDecimal(100));
		customer2.createAccount("mndp","9848619922", new BigDecimal(100));
	}
	@Test(expected=InvalidInputException.class)
	public void test23()
	{
	...
	public void test27()
	{
		...
		customer.fundTransfer("9247473364", "1234567890",new BigDecimal(700));
	}
	@Test(expected=InvalidInputException.class)
	public void test28()
	{
